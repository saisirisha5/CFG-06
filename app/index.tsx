    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#3a3a8a' }}>
      <View style={styles.container}>
        ...
        <View style={styles.pickerWrapper}>
          ...
          >
            <Picker.Item label="English" value="English" color="#ccc" />
            <Picker.Item label="Hindi" value="Hindi" color="#fff" />
            <Picker.Item label="Marathi" value="Marathi" color="#fff" />
            <Picker.Item label="Gujarati" value="Gujarati" color="#fff" />
          </Picker>
        </View>
